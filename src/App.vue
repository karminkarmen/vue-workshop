<template>
  <div id="app">
    ...
    <section class="container">
      <a class="btn" href="#less" @click.prevent="(page) ? page = page - 1 : 0">Previous page</a>
      {{ page }}
          ...
          <div class="product-list--product--footer">
            <template v-if="product.inStock > 0">
              <p class="product-list--product--price price">
                ${{ product.price }}  <span class="lozenge" v-show="product.price > 20">free shipping</span>
              </p>
    ...
    <div class="container">
      ...
      <form action="#" class="box product-edit">
        ...
        <div class="form-row">
          ...
          <input id="edit-photo" v-model.lazy="product.photo" type="text" />
          <img class="photo-preview" :src="product.photo" />
        </div>

        <div class="form-row">
          <label for="edit-desc">Description</label>
          <textarea v-model="product.description" id="edit-desc"></textarea>
        </div>
        ...
        <div class="form-row">
          ...
          <select v-model="product.department" id="edit-departmnet">
            <option>Books</option>
